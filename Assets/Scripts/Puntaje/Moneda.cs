...
public class Moneda : MonoBehaviour {
    ...
    void OnTriggerEnter2D (Collider2D obj)
    {
        if (obj.gameObject.name == "Personaje 1")   //si la moneda colisiona con el personaje entonces
        {
            ...
            Puntaje.score = Puntaje.score + 10; //Puntaje clase estatica para acceder al score, que se le suma 10

            Destroy(gameObject, 0.177f);
            //por ultimo se destruye el gameObject(moneda) con delay para que tener tiempo que se reproduzca la musica
